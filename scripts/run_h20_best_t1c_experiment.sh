...
export STAGE2_BEST_METRIC="${STAGE2_BEST_METRIC:-lesion_composite}"
...
export STAGE2_REFINEMENT_CHANNELS_MULTIPLIER="${STAGE2_REFINEMENT_CHANNELS_MULTIPLIER:-2}"
export STAGE2_REFINEMENT_BLOCKS="${STAGE2_REFINEMENT_BLOCKS:-4}"
export REFINEMENT_RESIDUAL_SCALE="${REFINEMENT_RESIDUAL_SCALE:-0.18}"
...
export REFINEMENT_RESIDUAL_TARGET_WEIGHT="${REFINEMENT_RESIDUAL_TARGET_WEIGHT:-0.25}"
export REFINEMENT_DIRECTION_WEIGHT="${REFINEMENT_DIRECTION_WEIGHT:-0.08}"
export REFINEMENT_RESIDUAL_BUDGET_WEIGHT="${REFINEMENT_RESIDUAL_BUDGET_WEIGHT:-0.35}"
export REFINEMENT_LESION_BUDGET_WEIGHT="${REFINEMENT_LESION_BUDGET_WEIGHT:-0.55}"
export REFINEMENT_NO_HARM_WEIGHT="${REFINEMENT_NO_HARM_WEIGHT:-0.40}"
export REFINEMENT_LESION_NO_HARM_WEIGHT="${REFINEMENT_LESION_NO_HARM_WEIGHT:-0.80}"
export REFINEMENT_BACKGROUND_NO_HARM_WEIGHT="${REFINEMENT_BACKGROUND_NO_HARM_WEIGHT:-0.30}"
...
echo "[BEST] Stage-2 refinement capacity: x${STAGE2_REFINEMENT_CHANNELS_MULTIPLIER}, blocks=${STAGE2_REFINEMENT_BLOCKS}, micro_windows=${MICRO_WINDOW_SIZES}"
